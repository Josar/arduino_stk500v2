...
#pragma message "FLASHEND=" STRINGIFY(FLASHEND)
#pragma message "BOOTSIZE=" STRINGIFY(BOOTSIZE)
#pragma message "APP_END=" STRINGIFY(APP_END)
...
//	#define SIGNATURE_BYTES  0x1ea702
//#elif defined (__AVR_ATmega64RFR2__)
//	#define SIGNATURE_BYTES  0x1ea602
#else
 ...
 */
 // Josua entfernen der 0.5 
	...
	#define UART_BAUD_SELECT(baudRate,xtalCpu) (((float)(xtalCpu))/(((float)(baudRate))*8.0)-1.0 +0.5)  // Josua remove +0.5?
#else
	#define UART_BAUD_SELECT(baudRate,xtalCpu) (((float)(xtalCpu))/(((float)(baudRate))*16.0)-1.0 +0.5) // Josua remove +0.5?
#endif
