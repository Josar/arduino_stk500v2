...
CFLAGS += $(CDEFS) $(CINCS)
CFLAGS += -O$(OPT)
CFLAGS += -fpack-struct -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -fno-jump-tables
...
# Adressing from datasheet is in WORD(16bit) but Adressing here is in Byte(8bit)
#  -> 2 * 0x1FC00 = 3F800
# 
# Fuses settings
# EXTENDED = 0xFE 
...
#
# Josua
# CFLAGS CFLAGS +=  -fdata-sections -Wl,--section-start=.bootlup=0x3FD00
#
# BOOTSZ = 0x1F000 (4096Byte)
# BOOTLOADER_ADDRESS = 0x3E000 
mega256rfr2:	CFLAGS += -fdata-sections -g3 -pedantic 
...
mega256rfr2: CFLAGS += -v
#mega256rfr2: export -n PATH
